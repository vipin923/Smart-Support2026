...
{
    public partial class Auto_Tag_Model
    {
        public const string RetrainFilePath =  @"D:\Web Application  Webapplication\Smart-Support2026\modelcsv\it_auto_tag.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Description",outputColumnName:@"Description")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator: mlContext.BinaryClassification.Trainers.LbfgsLogisticRegression(new LbfgsLogisticRegressionBinaryTrainer.Options(){L1Regularization=0.07593501F,L2Regularization=0.06251292F,LabelColumnName=@"Category",FeatureColumnName=@"Features"}), labelColumnName:@"Category"))      
