...
namespace Smart_Support2026
{
    ...
    {
        /// <summary>
        /// model input class for TicketSolutionModel.
        /// </summary>
        ...
        /// <summary>
        /// model output class for TicketSolutionModel.
        /// </summary>
        #region model output class
        public class ModelOutput
        {
            [ColumnName(@"TicketDescription")]
            public float[] TicketDescription { get; set; }
            ...
            [ColumnName(@"SuggestedSolution")]
            public float[] SuggestedSolution { get; set; }

            [ColumnName(@"FixID")]
            public float[] FixID { get; set; }
        ...
        private static string MLNetModelPath = Path.GetFullPath("TicketSolutionModel.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("ErrorType");
            if (labelColumn == null)
            {
                throw new Exception("ErrorType column not found. Make sure the name searched for matches the name in the schema.");
            }
